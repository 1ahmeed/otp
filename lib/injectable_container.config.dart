...
import 'package:otp_creative_minds/config/app_module_inject.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i3.ApiService>(() => _i3.ApiService.getDio());
    await gh.lazySingletonAsync<_i4.SharedPreferences>(
      () => appModuleInject.sharedPreferences,
      preResolve: true,
    );
    gh.factory<_i5.LangAndModeDataSource>(() => _i5.LangAndModeDataSourceImpl(
        sharedPreferences: gh<_i4.SharedPreferences>()));
    gh.factory<_i6.LangModeRepo>(() => _i7.LangRepoImpl(
        langAndModeDataSource: gh<_i5.LangAndModeDataSource>()));
    gh.factory<_i8.ChangeLangUseCase>(
        () => _i8.ChangeLangUseCase(langModeRepo: gh<_i6.LangModeRepo>()));
    gh.factory<_i9.ChangeModeUseCase>(
        () => _i9.ChangeModeUseCase(langModeRepo: gh<_i6.LangModeRepo>()));
    gh.factory<_i10.GetSavedLangUseCase>(
        () => _i10.GetSavedLangUseCase(langModeRepo: gh<_i6.LangModeRepo>()));
    gh.factory<_i11.GetSavedModeUseCase>(
        () => _i11.GetSavedModeUseCase(langModeRepo: gh<_i6.LangModeRepo>()));
    gh.factory<_i12.OtpRemoteDataSource>(
        () => _i12.OtpRemoteDataSourceImpl(apiService: gh<_i3.ApiService>()));
    gh.factory<_i13.OtpRepo>(() =>
        _i14.OtpRepoImpl(otpRemoteDataSource: gh<_i12.OtpRemoteDataSource>()));
    gh.factory<_i15.AppBloc>(() => _i15.AppBloc(
          changeLangUseCase: gh<_i8.ChangeLangUseCase>(),
          changeModeUseCase: gh<_i9.ChangeModeUseCase>(),
          getSavedLangUseCase: gh<_i10.GetSavedLangUseCase>(),
          getSavedModeUseCase: gh<_i11.GetSavedModeUseCase>(),
        ));
    gh.factory<_i16.ResendOtpUseCase>(
        () => _i16.ResendOtpUseCase(otpRepo: gh<_i13.OtpRepo>()));
    gh.factory<_i17.VerifyOtpUseCase>(
        () => _i17.VerifyOtpUseCase(otpRepo: gh<_i13.OtpRepo>()));
    gh.factory<_i18.OtpCubit>(() => _i18.OtpCubit(
          verifyOtpUseCase: gh<_i17.VerifyOtpUseCase>(),
          resendOtpUseCase: gh<_i16.ResendOtpUseCase>(),
        ));
    return this;
  }
}

class _$AppModuleInject extends _i19.AppModuleInject {}
